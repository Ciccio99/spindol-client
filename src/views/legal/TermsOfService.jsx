  ...
  <Container maxWidth="lg">
    <Paper elevation={0}>
      <Box p={3}>
        ...
        <Typography variant="body1" paragraph>Last update: May 29, 2020</Typography>
        <Typography variant="body1" paragraph>
          Welcome and thank you for your interest in SleepWell!  You are reviewing these Terms of Use because you use or have purchased, or are considering purchasing or using, the SleepWell/Hypnos Services (the “SleepWell Services” or “Hypnos Services”), other electronic devices (the “SleepWell Product” or  "Hypnos Product") to be used with the SleepWell mobile application (the “Mobile App”) and related website at sleepwell.ai (the “Website”) (collectively referred to as the “SleepWell System” or "Hypnos System" or "App" or "Web App" or “System”).
        </Typography>
        <Typography variant="body1" paragraph>
          THESE TERMS OF USE ARE A LEGAL AGREEMENT BETWEEN YOU AND SLEEPWELL. PLEASE READ THEM THROUGH CAREFULLY BEFORE USING ANY SLEEPWELL SYSTEM. By using the SleepWell System you signify your agreement to these Terms of Use (the “Terms of Use”). Please read these Terms carefully before accepting, and/or before downloading or installing or using the SleepWell System. By clicking on the “I accept” (or similar consent) button or downloading, installing or using all or any portion of the System, you are accepting all of the Terms and conditions of this agreement.  If you do not agree to all of these terms and conditions, do not click to accept or otherwise download, install or use the System.
        </Typography>
        <Typography variant="body1" paragraph>
          The SleepWell System has been developed and is owned by SleepWell which is referred to as SleepWell, “we”, “us” or “our” in these Terms of Use.  You are referred to as “you” or “your” in these Terms of Use.
        </Typography>
        ...
        <Typography variant="body1" paragraph>
          If you have any questions about the installation or use of the SleepWell/Hypnos System or have technical difficulties, you may e-mail us at contact@sleepwell.ai
        </Typography>
        <Typography variant="h5" gutterBottom>
        ...
        <Typography variant="body1" paragraph>
          We may modify these Terms of Use from time to time. The most current Terms of Use will be available on the SleepWell home page and the date of the latest update is indicated at the top of these Terms of Use. We may communicate major changes with a special notice on the SleepWell System or by email. You accept such modified Terms of Use by continuing to use of the SleepWell System.
        </Typography>
        <Typography variant="h5" gutterBottom>
          Requirements for Use of the SleepWell System
        </Typography>
        <Typography variant="body1" paragraph>
        ...
        <Typography variant="body1" paragraph>
          The SleepWell System is subject to the SleepWell Privacy Policy, which can be found at sleepwell.ai/privacy-policy
        </Typography>
        <Typography variant="h5" gutterBottom>
          Limited License and Ownership of the SleepWell System
        </Typography>
        <Typography variant="body1" paragraph>
          You are hereby granted a non-exclusive, revocable and nontransferable license to use the SleepWell System in accordance with these Terms of Use.
          SleepWell or its licensors own all title and rights to the SleepWell System, including, but is not limited, to all copyrights, trademarks, know-how and other intellectual property rights included therein. You may not reproduce (whether by linking, framing or any other method), transfer, distribute, store, modify, decompile, disassemble, or create derivative works of, publicly display, or commercially exploit any part of the SleepWell System except as necessary to display, download or print (without modification) for your own non-commercial use. All rights in the SleepWell System not expressly granted to you by SleepWell are retained by SleepWell and its licensors. Violation of any of these Terms of Use gives SleepWell sole discretion to refuse or terminate access to the SleepWell System effective immediately. In such an event you are obliged to immediately destroy any copies you have made of any portion of the SleepWell System.
        ...
        <Typography variant="body1" paragraph>
          You agree to defend, indemnify and hold SleepWell and its partners, affiliates, service providers, licensors, officers, directors, employees and agents harmless from and against any claims, actions or demands, including but not limited to reasonable legal and accounting fees, alleging or resulting from: (a) your violation of these Terms of Use; or (b) your violation of SleepWell’s intellectual property rights, any third party rights or any applicable law when using the SleepWell System.
        </Typography>
        <Typography variant="h5" gutterBottom>
        ...
        <Typography variant="body1" paragraph>
          In relation to your purchase and use of the SleepWell System, you agree to comply with the laws of your local jurisdiction as well as with any export restrictions of the United States and certain other countries on products or information.
        ...
        <Typography variant="body1" paragraph>
          To increase value to our users, we may provide links or references to third party websites, services, or products within the SleepWell System. We have no control of such websites or services and do not assume any responsibility or liability for any damage or loss of any kind for or due to their content, functionality, or practices. If you decide to access these third-party websites or services, you do so at your own risk. SleepWell suggests that before using these third-party websites or services you read their terms of use and privacy policies (if any).
        ...
        <Typography variant="body1" paragraph>
          SleepWell/Hypnos logo, and SleepWell/Hypnos are trademarks or registered trademarks of Moonshot Brewing Holdings, INC. Patented and patents pending. © Moonshot Brewing Holdings, INC (SleepWell/Hypnos) 2019. All rights reserved. You are not granted, by implication or otherwise, any license or right to use any marks appearing on the SleepWell System. One or more patents owned by Moonshot Brewing Holdings, INC (or patents licensed from third parties) apply to the SleepWell Products and to the features and services accessible via the SleepWell System maintained by SleepWell.
        </Typography>
        <Typography variant="body1" paragraph>
        ...
        <Typography variant="body1" paragraph>
          Customer hereby grants Moonshot Brewing Co. the right to identify Customer as a SleepWell.ai/Hypnos.ai Customer, and use Customer’s name, mark and/or logo on SleepWell/Hypnos’s website and/or in SleepWell/Hypnos’s marketing materials in connection with the Customer’s use of the System.
        </Typography>
        <Typography variant="h5" gutterBottom>
          General
        </Typography>
        <Typography variant="body1" paragraph>
          English language shall govern all documents, notices, and interpretations of these Terms of Use. Relevant Sections, including but not limited to Sections titled Precautions, Indemnity, Content and Warranty Disclaimer, Limitation of Liability and Governing Law and Disputes shall survive and remain in effect after your license to use the SleepWell System has terminated for any or no reason.
          SleepWell’s failure to exercise or enforce any right or provision of these Terms of Use will not constitute a waiver of such right or provision unless acknowledged and agreed to by SleepWell in writing. These Terms of Use constitute the entire agreement between you and SleepWell with respect to the subject matter herein and supersede any and all prior or contemporaneous oral or written agreements. You may not assign this agreement to any other party and any attempt to do so is void.
